...
#Login credentials
st.write('Provide your fantasy premier league login and click load team. The load team button will only appear once you fill out all the fields you muppet.')
...
if get_email_address and get_password and get_team_id:
    if st.button('Load Team'):
        with st.spinner('Hold on... We are fetching your request. In the meantime, suck your nan'):
            time.sleep(5)
